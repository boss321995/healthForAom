...
ADD uric_acid DECIMAL(5,2) COMMENT 'กรดยูริกในเลือด (mg/dL)',
ADD alt DECIMAL(6,2) COMMENT 'ALT - ตับ (U/L)',
ADD ast DECIMAL(6,2) COMMENT 'AST - ตับ (U/L)',
ADD hemoglobin DECIMAL(5,2) COMMENT 'ฮีโมโกลบิน (g/dL)',
ADD hematocrit DECIMAL(5,2) COMMENT 'ฮีมาโตคริต (%)',
ADD iron DECIMAL(6,2) COMMENT 'ธาตุเหล็ก (μg/dL)',
ADD tibc DECIMAL(6,2) COMMENT 'TIBC - ความจุรวมของการจับธาตุเหล็ก (μg/dL)';
